...
const Dashboard = () => {
  ...
  const handleNextBreakOperation = async () => {
    if (nextBreakDateInput.length === 0) {
      addToast(
        <FormattedMessage
          id="timeNotSelected"
          defaultMessage="Time is not selected"
        />,
        {
          appearance: "warning",
        }
  ...
  //
  const creatVacationTime = async (e) => {
    e.preventDefault();
    try {
                    ...
                    renderer={(props) => (
                      <>
                        {props.days === 0 && props.hours === 0 ? (
                          <span className="vacation-until">
                            <FormattedMessage
                              defaultMessage="Enjoy your vacation time"
              ...
              <Row>
                {showSkleton ? (
                  ...
                  <span className="text-center no-task-today">
                    ...
                    />
                    <br />
                    <FormattedMessage id="task.or" defaultMessage="or" />
                    <br />
                    <FormattedMessage
                      id="task.daypoint"
