    ...
    <div className="login-page">
      <div className="login-card">
        <div className="login-header text-center pt-4">
          ...
          <div className="login-header-title mt-3">
        ...
        <div className="login-body">
          <Form>
            ...
            <Form.Group className="mb-4" controlId="formBasicPassword">
              ...
              <div className="mb-4 input-group">
                ...
                <i
                  ...
                  class="input-group-text login-form-input password-icon"
                  id="btnGroupAddon"
                >
                  {!showPassword ? (
            ...
            <Form.Group className="mb-4" controlId="formBasicCheckbox">
              <Form.Check
                type="checkbox"
                className="login-lable-form mt-2"
                label="Check me out"
              />
              <Link className="forget-pass-link" to="">
                Forgot password?
              </Link>
            </Form.Group>
